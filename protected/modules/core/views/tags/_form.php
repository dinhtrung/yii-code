...
<p class="hint"><?php if('_HINT_Tags.name' != $hint = Yii::t('core', '_HINT_Tags.name')) echo $hint; ?></p>
</div>
...
<p class="hint"><?php if('_HINT_Tags.frequency' != $hint = Yii::t('core', '_HINT_Tags.frequency')) echo $hint; ?></p>
</div>
