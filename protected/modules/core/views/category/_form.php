...
<p class="hint"><?php if('_HINT_Category.title' != $hint = Yii::t('core', '_HINT_Category.title')) echo $hint; ?></p>
</div>
...
<?php echo $form->dropDownList($model,'root',
	array('' => Yii::t('core', '--- Select Parent Category ---')) + Category::getOption()); ?>
<?php echo $form->error($model,'root'); ?>
<p class="hint"><?php if('_HINT_Category.root' != $hint = Yii::t('core', '_HINT_Category.root')) echo $hint; ?></p>
</div>
