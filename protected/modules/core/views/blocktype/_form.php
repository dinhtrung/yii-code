...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('blocktype', "Name of this block type. Used in administration interfaces"); ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('blocktype', "Yii Component that provide Callback Data and Config functions, written in Yii path alias."); ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('blocktype', "Prefix for the callback functions.<br> This block configuration will be provided by function <code><em>callback</em>Config</code> while data will be provided by <code><em>callback</em>Data</code> in the component above."); ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('blocktype', "The view file this block type will use. Provided as Yii path alias format."); ?></p>
