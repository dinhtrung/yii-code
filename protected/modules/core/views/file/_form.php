...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_File.title' != $hint = Yii::t('file', '_HINT_File.title')) echo $hint; ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_File.description' != $hint = Yii::t('file', '_HINT_File.description')) echo $hint; ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_File.name' != $hint = Yii::t('file', '_HINT_File.name')) echo $hint; ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_File.path' != $hint = Yii::t('file', '_HINT_File.path')) echo $hint; ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_File.entity' != $hint = Yii::t('file', '_HINT_File.entity')) echo $hint; ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_File.pkey' != $hint = Yii::t('file', '_HINT_File.pkey')) echo $hint; ?></p>
</div>
