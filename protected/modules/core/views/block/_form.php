...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('core', "Title of this block, to be displayed on Administration page."); ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('core', "Block types provide various features to the CMS. Each block type will have its own behaviors."); ?></p>
</div>
<?php $this->endWidget(); ?>
...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('core', "If specified, the block will be render to the end users with this label."); ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php echo Yii::t('core', "Temporary disable this block."); ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_Block.display' != $hint = Yii::t('core', '_HINT_Block.display')) echo $hint; ?></p>
</div>
...
<div class="row">
	...
	<p class="hint"><?php if('_HINT_Block.url' != $hint = Yii::t('core', '_HINT_Block.url')) echo $hint; ?></p>
</div>
<?php $this->endWidget(); ?>
