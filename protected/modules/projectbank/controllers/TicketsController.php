...
class TicketsController extends WebBaseController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Tickets']))
		{
			...
			if (empty($_POST['Tickets']['root'])){
				...
				$model->project_id = $root->project_id;
				$model->appendTo($root);
			}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Tickets']))
		{
			...
			if (empty($_POST['Tickets']['root'])){
				...
				$model->saveNode();
				if ($root->primaryKey != $model->primaryKey) $model->moveAsLast($root);
			} 
			$this->redirect(array('view','id'=>$model->id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider(Tickets::model()->roots());
