...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row range">
		...
		<p class="hint"><?php echo Yii::t('user', 'Predefined values (example: 1;2;3;4;5 or 1==One;2==Two;3==Three;4==Four;5==Five).'); ?></p>
	</div>
	...
	<div class="row other_validator">
		...
		<p class="hint"><?php echo Yii::t('user', 'JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('file'=>array('types'=>'jpg, gif, png'))))); ?></p>
	</div>
	...
	<div class="row widget">
		...
		<p class="hint"><?php echo Yii::t('user', 'Widget name.'); ?></p>
	</div>
	...
	<div class="row widgetparams">
		...
		<p class="hint"><?php echo Yii::t('user', 'JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('param1'=>array('val1','val2'),'param2'=>array('k1'=>'v1','k2'=>'v2'))))); ?></p>
	</div>
...
<div id="dialog-form" title="<?php echo Yii::t('user', 'Widget parametrs'); ?>">
	<form>
	<fieldset>
