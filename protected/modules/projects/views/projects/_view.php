...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('target_budget')); ?>:</b>
	<?php echo CHtml::encode($data->target_budget); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('actual_budget')); ?>:</b>
	<?php echo CHtml::encode($data->actual_budget); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('demo_url')); ?>:</b>
	<?php echo CHtml::encode($data->demo_url); ?>
	<br />
