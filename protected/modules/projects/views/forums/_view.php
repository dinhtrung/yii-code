...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('message_count')); ?>:</b>
	<?php echo CHtml::encode($data->message_count); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('moderated')); ?>:</b>
