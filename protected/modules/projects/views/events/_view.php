...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('times_recuring')); ?>:</b>
	<?php echo CHtml::encode($data->times_recuring); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('recurs')); ?>:</b>
	<?php echo CHtml::encode($data->recurs); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('cwd')); ?>:</b>
	<?php echo CHtml::encode($data->cwd); ?>
	<br />
