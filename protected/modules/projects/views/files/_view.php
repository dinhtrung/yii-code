...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('real_filename')); ?>:</b>
	<?php echo CHtml::encode($data->real_filename); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('co_reason')); ?>:</b>
	<?php echo CHtml::encode($data->co_reason); ?>
	<br />
