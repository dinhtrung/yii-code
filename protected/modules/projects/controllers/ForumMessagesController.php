...
class ForumMessagesController extends WebBaseController
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation($model, 'forummessages-form');
	...
	{
		$dataProvider=new CActiveDataProvider('ForumMessages');
