<?php
/**
 * This is the model class for table "task_department".
 *
 * The followings are the available columns in table 'task_department':
 * @property integer $tid
 * @property integer $did
 */
class TaskDepartment extends BaseActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TaskDepartment the static model class
	 */
