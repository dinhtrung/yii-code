<?php
/**
 * This is the model class for table "task_contact".
 *
 * The followings are the available columns in table 'task_contact':
 * @property integer $tid
 * @property integer $cid
 */
class TaskContact extends BaseActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TaskContact the static model class
	 */
