...
<h1><?php echo $this->pageTitle = Yii::t('core', 'View Webmenu :item', array(':item' => CHtml::encode($model->label))); ?></h1>
...
<h2><?php echo Yii::t('core', "Ancestors of Webmenu :item", array(':item' => CHtml::encode($model->label)))?></h2>

<?php foreach ($model->ancestors()->findAll() as $data) $this->renderPartial("_view", array('data' => $data)); ?>

<h2><?php echo Yii::t('core', "Decendances of Webmenu :item", array(':item' => CHtml::encode($model->label)))?></h2>
