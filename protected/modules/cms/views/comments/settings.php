...
$this->breadcrumbs=array(
	Yii::t('cms', 'Comments')	=>	array(Yii::t('cms', 'index')),
	Yii::t('cms', 'Settings'),
);
...
<h1><?php echo Yii::t('cms', "Create Comments")</h1>


<div class="form">
<p class="note">
<?php echo Yii::t('cms','Fields with');?> <span class="required">*</span> <?php echo Yii::t('cms','are required');?>.
</p>
