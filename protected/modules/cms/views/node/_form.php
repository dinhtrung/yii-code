...
<p class="hint"><?php if('_HINT_Node.title' != $hint = Yii::t('cms', '_HINT_Node.title')) echo $hint; ?></p>
</div>
...
<p class="hint"><?php if('_HINT_Node.body' != $hint = Yii::t('cms', '_HINT_Node.body')) echo $hint; ?></p>
</div>
...
<p class="hint"><?php if('_HINT_Node.category' != $hint = Yii::t('cms', '_HINT_Node.category')) echo $hint; ?></p>
</div>
...
<?php echo $form->dropDownList($model,'cid',
	array('' => Yii::t('cms', '--- Select Parent Category ---')) + Category::getOption(Yii::app()->setting->get("Node", "cid", 1))); ?>
<?php echo $form->error($model,'category'); ?>
<p class="hint"><?php if('_HINT_Node.category' != $hint = Yii::t('cms', '_HINT_Node.category')) echo $hint; ?></p>
</div>
...
<p class="hint"><?php if('_HINT_Node.tags' != $hint = Yii::t('cms', '_HINT_Node.tags')) echo $hint; ?></p>
</div>
