...
?>
<h1>
<?php echo $this->pageTitle = Yii::t('cms', 'Continue Delete') . ' ' . Yii::t('cms', 'Categories :name', array(':name' => CHtml::encode($model))); ?>
</h1>
<div class="form">
<p class="note">
	<?php echo Yii::t('cms','Are you sure you want to delete this Category :name?', array(':name' => CHtml::encode($model)));?>.
</p>
