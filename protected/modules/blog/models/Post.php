...
(
	...
	protected function createTable(){
		...
		try {
			$ref = new Comment();
			$this->getDbConnection()->createCommand(
					Yii::app()->getDb()->getSchema()->addForeignKey('fk_post', $ref->tableName(), 'post_id', $this->tableName(), 'id')
			)->execute();
		} catch (CDbException $e){
			Yii::log($e->getMessage(), 'warning');
		}
