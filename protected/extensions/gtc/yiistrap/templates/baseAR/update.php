...
$this->menu=array(
	...
	array('label'=>'View <?php echo $this->modelClass; ?>', 'url'=>array('view', <?php echo $pk; ?>)),
...
<h1><?php echo "<?php echo \$this->pageTitle = Yii::t('app', 'Update {$this->modelClass} :title', array(':title' => \$model->title)); ?>"?></h1>
