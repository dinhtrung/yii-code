...
class elRTE extends CInputWidget
{
    ...
    {                
        ...
        $js .= "elRTE.prototype.options.panels.myToolbar = ['bold', 'italic', 'underline',
            ...
            'docstructure','paste','removeformat','link','unlink', 'elfinder', 'image', 'fullscreen']; \n";
        ...
        Yii::app()->clientScript->registerScript('Yii.elRTE_Page_html_content',$js,CClientScript::POS_BEGIN);
    }
