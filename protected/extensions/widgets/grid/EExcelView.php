	...
	*/
	class EExcelView extends CGridView
	{
		...
		public function init()
		{
			...
			Yii::import('ext.vendors.phpexcel.Classes.PHPExcel', true);
		...
		public function run()
		{
			...
			else //output to browser
			{
				...
				header('Content-type: '.self::$mimeTypes[$this->exportType]['Content-type']);
				header('Content-Disposition: attachment; filename="'.$this->filename.'.'.self::$mimeTypes[$this->exportType]['extension'].'"');
