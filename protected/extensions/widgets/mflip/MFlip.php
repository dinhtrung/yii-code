 ...
 * $data = array(
 * 	array('facebook.jpg','The biggest social network in the world.','http://www.facebook.com/','facebook title'),
 ...
 *     'sponsors'=>$data,    //the items to be flipped
...
class MFlip extends CWidget {
    ...
    public function init() {
        ...
        Yii::app()->getClientScript()->registerCss('mflip', '.sponsor { width:' . $this->width . 'px; height: '. $this->height . 'px;}', 'screen, projection');
    ...
    public function run() {
        if (!empty($this->data)) {
            $this->shuffle ? shuffle($this->data): '';
            foreach ($this->data as $data) {
                $title = isset($data[3]) ?  $data[3]: $this->title;
                    ...
                    <div class="sponsor" title="'.$title.'">
                            ...
                            <div class="sponsorData">
                                    ...
                                    <div class="sponsorURL">
                                            ' . CHtml::link($data[2], $data[2], array('target' => '_blank')) . '
                                    </div>
                            </div>
                    </div>
