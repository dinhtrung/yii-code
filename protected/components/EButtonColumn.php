...
*   //'clearButtonImageUrl'=>'/path/to/custom/image/delete.png',
...
*
* clearButtonImageUrl: image URL of the button. If not set or false, a text link is used
...
class EButtonColumn extends CButtonColumn {
    ...
    public function init()
    {
        ...
        if (!empty($this->clearButtonImageUrl)) {
            $_clearButtonImageUrl=$this->clearButtonImageUrl;
        } else {
            $_clearButtonImageUrl=$this->grid->baseScriptUrl.'/delete.png';
        }
        ...
        $this->buttons['clear'] = $this->_clearButton;
