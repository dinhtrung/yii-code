...
class Settings extends CApplicationComponent
{
    ...
    public function init()
    {
    	if (YII_DEBUG && ! Yii::app()->getDb()->getSchema()->getTable('settings')){
    		$createTableQuery = Yii::app()->getDb()->getSchema()->createTable('settings', array('category' => 'string', 'key' => 'string', 'value' => 'text'));
